...
My research focuses on **Remote Sensing, GIS, Precision Agriculture, Hydrology, Climate Change, Machine Learning, and Geospatial Analytics**.
...
!!! success "Identification of groundwater recharge potential zone using geospatial approaches and multi criteria decision models in Udham Singh Nagar district, Uttarakhand, India"
    ...
    **Quartile:** Q1
    ...
    [Read Article](https://doi.org/10.1016/j.asr.2024.10.039){ .md-button .md-button--primary }
...
!!! success "Integrating Statistical Analysis and Decision-Making to Assess Flood Susceptibility in Indian Mountainous Agroecosystems"
    ...
    **Quartile:** Q3
    ...
    [Read Article](https://link.springer.com/article/10.1007/s12040-026-02781-9){ .md-button .md-button--primary }    
...
!!! abstract "Morphometric Characterization of Netravati River Using Geospatial Tools"

    **Conference:** 27th International Conference on Hydraulics, Water Resources, Environmental and Coastal Engineering (HYDRO 2022)

    **Venue:** Punjab Engineering College, Chandigarh, India

    **Date:** 22–24 December 2022
